...
cat << EOF | sudo tee /etc/systemd/network/99-default.link.d/veth.conf
# Ensure MACAddressPolicy=none, installing systemd-udev writes /usr/lib/systemd/network/99-default.link
